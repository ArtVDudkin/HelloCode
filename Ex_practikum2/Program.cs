...
// int Sum(int n, int razr)
// {
//     int result = 0;
//     for (index = 0; index <= razr; index++)
//         {
//             result += n % 10;
//             n /= 10;
//         } 
...
// Console.WriteLine($"Сумма цифр числа {number} равна {Sum(number, Razr(number))}");
...
// }
// int b = countdown(5); 
// Console.WriteLine($"Числа от 1 до 5: {countdown(5)}");

// сумма первых n чисел кратных 5
// int S(int n)
// {
//     if (n == 1)
//         return 5;
...
//         return 5 * n + S(n - 1);
// }
// Console.WriteLine($"Числа от 1 до 5: {S(1)}");
